...
export default function Edit({ template }: any) {
    const { data, setData, put, processing, errors } = useForm({
        purpose: template.purpose || 'welcome',
        name: template.name || '',
        is_email_active: template.is_email_active ?? false,
        email_subject: template.email_subject || '',
        email_body: template.email_body || '',
        is_sms_active: template.is_sms_active ?? false,
        sms_body: template.sms_body || '',
        is_whatsapp_active: template.is_whatsapp_active ?? false,
    ...
    return (
        <>
            ...
            <Container>
                <Toolbar>
                    <ToolbarHeading title="Edit Template" description="Update your unified notification template." />
                    <ToolbarActions>
