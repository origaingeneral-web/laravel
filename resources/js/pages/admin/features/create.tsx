            ...
            <Container>
                <Toolbar>
                    <ToolbarHeading
                        ...
                        description="Add a new feature or addon module to a product."
                    />
                    <ToolbarActions>
            ...
            <Container className="pb-10">
                <Card className="max-w-2xl mx-auto border-border/50 shadow-sm rounded-2xl overflow-hidden">
                    <CardHeader className="bg-muted/10 border-b border-border/50">
                        ...
                        <CardDescription>Configure core properties, module type, and pricing.</CardDescription>
                    </CardHeader>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g. Recruitment, Payroll, Attendance, AI Assistant"
