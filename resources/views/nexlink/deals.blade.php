...
<!-- Mirrored from nexlink.layoutdrop.com/demo/deals.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
...
<body>
  ...
  <script src="{{ asset('nexlink/assets/libs/datatables/datatables.min.js') }}"></script><script src="{{ asset('nexlink/assets/js/dashboard/deals.js') }}"></script>
