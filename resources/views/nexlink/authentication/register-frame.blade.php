...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/register-frame.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
        ...
        <div class="col-xl-4 col-lg-5 col-md-6 align-self-center">
          <div class="p-4 p-sm-5 maxw-450px m-auto">
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <p class="mb-5 text-center">Have any account? <a href="{{ url('/nexlink/authentication/login-frame') }}">Sign In here</a>
              </p>
              ...
              <button type="submit" class="btn btn-light waves-effect waves-light w-100">
                <img src="{{ asset('nexlink/assets/images/icons/google.svg') }}" alt="" class="me-1"> Sign up with Google
              </button>
            </form>
          </div>
        </div>
