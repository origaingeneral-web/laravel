...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/register-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
        ...
        <div class="col-xl-5 col-lg-6 ms-auto px-sm-4 align-self-center py-4">
          <div class="card card-body p-4 p-sm-5 maxw-450px m-auto rounded-4">
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <p class="mb-5 text-center">Have any account? <a href="{{ url('/nexlink/authentication/login') }}">Sign In here</a>
              </p>
