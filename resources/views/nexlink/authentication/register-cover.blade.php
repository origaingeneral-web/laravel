...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/register-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
        ...
        <div class="col-md-6 align-self-center">
          <div class="px-3 py-5 p-sm-5 maxw-450px m-auto">
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <p class="mb-5 text-center">Have any account? <a href="{{ url('/nexlink/authentication/login-cover') }}">Sign In here</a>
              </p>
