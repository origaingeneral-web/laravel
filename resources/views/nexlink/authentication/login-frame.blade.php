...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/login-frame.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:44 GMT -->
<head>
    ...
    <div class="auth-frame-wrapper">
      <div class="row g-0 h-100">
        <div class="col-xl-8 col-lg-7 col-md-6">
          <div class="auth-frame" style="background-image: url({{ asset('nexlink/assets/images/auth/auth-frame.webp') }});"></div>
        </div>
        <div class="col-xl-4 col-lg-5 col-md-6 align-self-center">
          <div class="p-4 p-sm-5 maxw-450px m-auto">
            <div class="mb-4 text-center">
              <a href="{{ url('/nexlink') }}" aria-label="NexLink logo">
                <img class="visible-light" src="{{ asset('nexlink/assets/images/logo.svg') }}" alt="NexLink logo">
              </a>
            </div>
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="{{ url('/nexlink/authentication/forgot-password-frame') }}">Forgot Password?</a>
                </div>
              </div>
              <div class="mb-3">
                <button type="submit" value="Submit" class="btn btn-primary waves-effect waves-light w-100">Login</button>
              </div>
              <p class="mb-5 text-center">Don’t have an account? <a href="{{ url('/nexlink/authentication/register-frame') }}">Sign Up here</a>
              </p>
              ...
              <button type="submit" class="btn btn-light waves-effect waves-light w-100">
                <img src="{{ asset('nexlink/assets/images/icons/google.svg') }}" alt="" class="me-1"> Login with Google
              </button>
            </form>
          </div>
        </div>
