...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
      ...
      <div class="row g-0">
        <div class="col-md-6 order-md-1">
          <div class="auth-cover">
            <div class="clearfix">
              <img src="{{ asset('nexlink/assets/images/auth/vector1.svg') }}" alt="" class="img-fluid cover-img">
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="{{ url('/nexlink/authentication/forgot-password-cover') }}">Forgot Password?</a>
                </div>
              </div>
              <div class="mb-3">
                <button type="submit" value="Submit" class="btn btn-primary waves-effect waves-light w-100">Login</button>
              </div>
              <p class="mb-5 text-center">Don’t have an account? <a href="{{ url('/nexlink/authentication/register-cover') }}">Sign Up here</a>
              </p>
