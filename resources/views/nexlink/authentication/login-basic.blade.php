...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:42 GMT -->
<head>
    ...
    <div class="auth-wrapper min-vh-100 px-2">
      <div class="row g-0 min-vh-100">
        <div class="col-xl-5 col-lg-6 ms-auto px-sm-4 align-self-center py-4 d-none d-lg-block">
          <img src="{{ asset('nexlink/assets/images/auth/vector2.svg') }}" alt="" class="img-fluid">
        </div>
            ...
            <form action="{{ url('/nexlink') }}">
              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="{{ url('/nexlink/authentication/forgot-password-basic') }}">Forgot Password?</a>
                </div>
              </div>
              <div class="mb-3">
                <button type="submit" value="Submit" class="btn btn-primary waves-effect waves-light w-100">Login</button>
              </div>
              <p class="mb-5 text-center">Don’t have an account? <a href="{{ url('/nexlink/authentication/register-basic') }}">Sign Up here</a>
              </p>
