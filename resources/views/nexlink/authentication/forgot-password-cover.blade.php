...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/forgot-password-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 align-self-center">
          <div class="px-3 py-5 p-sm-5 maxw-450px m-auto">
            ...
            <form action="{{ url('/nexlink/authentication/new-password-cover') }}">
              <div class="mb-4">
              ...
              <div class="clearfix">
                ...
                <a href="{{ url('/nexlink/authentication/login-cover') }}" class="btn btn-light waves-effect waves-light w-100"> Cancel </a>
              </div>
            </form>
          </div>
        </div>
