...
<!-- Mirrored from nexlink.layoutdrop.com/demo/authentication/forgot-password-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
      ...
      <div class="row g-0 min-vh-100">
        ...
        <div class="col-xl-5 col-lg-6 ms-auto px-sm-4 align-self-center py-4">
          <div class="card card-body p-4 p-sm-5 maxw-450px m-auto rounded-4">
            ...
            <form action="{{ url('/nexlink/authentication/new-password-basic') }}">
              <div class="mb-4">
              ...
              <div class="clearfix">
                ...
                <a href="{{ url('/nexlink/authentication/login-basic') }}" class="btn btn-light waves-effect waves-light w-100"> Cancel </a>
              </div>
            </form>
          </div>
        </div>
