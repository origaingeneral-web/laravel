...
<!-- Mirrored from nexlink.layoutdrop.com/demo/task-management.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:42 GMT -->
<head>
...
<body>
        ...
        <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-4">
          <div class="clearfix">
            <ul class="nav nav-pills nav-pills-custom nav-fill p-1 bg-light rounded-5">
              ...
              <li class="nav-item">
                <a class="nav-link rounded-5" href="{{ url('/nexlink/calendar') }}">Calendar</a>
              </li>
            </ul>
          </div>
  ...
  <script src="{{ asset('nexlink/assets/js/plugins/task.js') }}"></script>
