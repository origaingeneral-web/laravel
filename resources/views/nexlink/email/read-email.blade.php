...
<!-- Mirrored from nexlink.layoutdrop.com/demo/email/read-email.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
            ...
            <div class="card card-body overflow-hidden mail-wrapper p-0">
              ...
              <div class="mail-sidebar bg-light">
                <div class="px-3 pt-3 mb-2">
                  <a href="{{ url('/nexlink/email/compose') }}" class="btn btn-primary waves-effect waves-light w-100">
                    Compose
                  </a>
                </div>
                <div class="d-grid gap-2 p-2 mail-nav" id="myTab" role="tablist" data-simplebar>
                  <a href="{{ url('/nexlink/email/inbox') }}" class="mail-nav-item active">
                    <i class="fi fi-rr-inbox-in me-2"></i> Inbox
                    <span class="badge badge-sm bg-primary-subtle text-primary ms-auto">247</span>
                  </a>
                  <a href="{{ url('/nexlink/email/inbox') }}" class="mail-nav-item">
                  ...
                  <a href="{{ url('/nexlink/calendar') }}" class="mail-nav-item">
              ...
              <div class="mail-body">
                <div class="mail-header">
                  <div class="d-flex gap-3">
                    ...
                    <div class="me-2">
                      <a href="{{ url('/nexlink/email/inbox') }}" class="btn btn-white btn-shadow btn-icon waves-effect me-2">
                    ...
                    <div class="p-3 bg-light rounded-2">
                      <div class="row g-2">
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="{{ asset('nexlink/assets/images/media/svg/media3.svg') }}" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3 border">
                              <img src="{{ asset('nexlink/assets/images/media/svg/media4.svg') }}" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="{{ asset('nexlink/assets/images/media/svg/media5.svg') }}" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="{{ asset('nexlink/assets/images/media/svg/media6.svg') }}" alt="">
                            </div>
                            <div class="clearfix">
