...
<!-- Mirrored from nexlink.layoutdrop.com/demo/pages/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>

  <base href="{{ url('/nexlink') }}/">
  ...
  <link rel="icon" type="image/png" href="{{ asset('nexlink/assets/images/favicon.png') }}">
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('nexlink/assets/images/apple-touch-icon.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/flaticon/css/all/all.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/lucide/lucide.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/fontawesome/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/simplebar/simplebar.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/node-waves/waves.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/bootstrap-select/css/bootstrap-select.min.css') }}">
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/flatpickr/flatpickr.min.css') }}">
  <!-- end::NexLink Required Stylesheet -->

  <!-- begin::NexLink CSS Stylesheet -->
  <link rel="stylesheet" href="{{ asset('nexlink/assets/css/styles.css') }}">
...
<body>
  <div class="page-layout">
      ...
      <div class="app-header-inner">
        ...
        <div class="app-header-end">
          ...
          <div class="d-flex align-items-center gap-sm-2 gap-0 px-lg-4 px-sm-2 px-1">
            <a href="{{ url('/nexlink/email/inbox') }}" class="btn btn-icon btn-action-gray rounded-circle waves-effect waves-light position-relative">
                  ...
                  <ul class="list-group list-group-hover list-group-smooth list-group-unlined">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="avatar avatar-xs avatar-status-success rounded-circle me-1">
                        <img src="{{ asset('nexlink/assets/images/avatar/avatar2.webp') }}" alt="">
                      </div>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="avatar avatar-xs avatar-status-success rounded-circle me-1">
                        <img src="{{ asset('nexlink/assets/images/avatar/avatar3.webp') }}" alt="">
                      </div>
                      <div class="ms-2 me-auto">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="avatar avatar-xs avatar-status-danger rounded-circle me-1">
                        <img src="{{ asset('nexlink/assets/images/avatar/avatar5.webp') }}" alt="">
                      </div>
                      <div class="ms-2 me-auto">
            ...
            <a href="{{ url('/nexlink/calendar') }}" class="btn btn-icon btn-action-gray rounded-circle waves-effect waves-light">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="dropdown text-end ms-sm-3 ms-2 ms-lg-4">
            <a href="#" class="d-flex align-items-center py-2" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="true">
              ...
              <div class="avatar avatar-sm rounded-circle avatar-status-success">
                <img src="{{ asset('nexlink/assets/images/avatar/avatar1.webp') }}" alt="">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
              ...
              <li>
                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ url('/nexlink/profile') }}">
                  <i class="fi fi-rr-user scale-1x"></i> View Profile
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ url('/nexlink/task-management') }}">
                  <i class="fi fi-rr-note scale-1x"></i> My Task
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ url('/nexlink/settings') }}">
                  <i class="fi fi-rr-settings scale-1x"></i> Account Settings
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ url('/nexlink/pages/pricing') }}">
              ...
              <li>
                <a class="dropdown-item d-flex align-items-center gap-2 text-danger" href="{{ url('/nexlink/authentication/login-basic') }}">
          ...
          <div class="modal-body pb-2" style="height: 300px;" data-simplebar>
            <div id="recentlyResults">
              ...
              <ul class="list-inline search-list">
                <li>
                  <a class="search-item" href="{{ url('/nexlink') }}">
                    <i class="fi fi-rr-apps"></i> Dashboard
                  </a>
                </li>
                <li>
                  <a class="search-item" href="{{ url('/nexlink/chat') }}">
                    <i class="fi fi-rr-comment"></i> Chat
                  </a>
                </li>
                <li>
                  <a class="search-item" href="{{ url('/nexlink/calendar') }}">
                    <i class="fi fi-rr-calendar"></i> Calendar
                  </a>
                </li>
                <li>
                  <a class="search-item" href="{{ url('/nexlink/chart/apexchart') }}">
                    <i class="fi fi-rr-chart-pie-alt"></i> Apexchart
                  </a>
                </li>
                <li>
                  <a class="search-item" href="{{ url('/nexlink/pages/pricing') }}">
                    <i class="fi fi-rr-file"></i> Pricing
                  </a>
                </li>
                <li>
                  <a class="search-item" href="{{ url('/nexlink/email/inbox') }}">
    ...
    <aside class="app-menubar-tabs" id="appMenubar">
      <div class="app-navbar-brand">
        <a class="navbar-brand-logo" href="{{ url('/nexlink') }}">
          <img src="{{ asset('nexlink/assets/images/logo.svg') }}" alt="NexLink Admin Dashboard Logo">
        </a>
      </div>
      <div class="app-navbar-tabs" data-simplebar>
        <ul class="nav" id="appMenubarTabs" role="tablist" aria-orientation="vertical">
          ...
          <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Ai ChatBot">
            <a class="menu-link position-relative" href="{{ url('/nexlink/ai/new-chat') }}">
          ...
          <li class="nav-item mt-5" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Login">
            <a class="menu-link" href="{{ url('/nexlink/authentication/login-frame') }}">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="app-tab-content">
        <div class="app-side-brands">
          <a class="navbar-brand-text" href="{{ url('/nexlink') }}">NexLink</a>
        </div>
            ...
            <div class="tab-pane fade show active" id="dashboardTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink') }}" role="button">
                      <i class="fi fi-rr-house-blank"></i>
                      <span class="menu-label">Default Dashboard</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/sales') }}" role="button">
                      <i class="fi fi-rr-percent-100"></i>
                      <span class="menu-label">Sales Dashboard</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/finance') }}" role="button">
                      <i class="fi fi-rr-growth-chart-invest"></i>
                      <span class="menu-label">Finance Dashboard</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/team-management') }}" role="button">
                      <i class="fi fi-rr-circle-user"></i>
                      <span class="menu-label">Team Management</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/employee') }}" role="button">
                      <i class="fi fi-rr-employee-man"></i>
                      <span class="menu-label">Employees</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/customers') }}" role="button">
                      <i class="fi fi-rr-review"></i>
                      <span class="menu-label">Customers</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/review') }}" role="button">
                      <i class="fi fi-rr-star"></i>
                      <span class="menu-label">Review</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/task-management') }}" role="button">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/user-management') }}" role="button">
                      <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/activities') }}" role="button">
                      <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/deals') }}" role="button">
                      <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tab-pane fade" id="appsTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/chat') }}">
                      <i class="fi fi-rr-comment"></i>
                      <span class="menu-label">Chat</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/calendar') }}">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/email/inbox') }}">
                      <i class="fi fi-rr-inbox-in"></i>
                      <span class="menu-label">Inbox</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/email/compose') }}">
                      <i class="fi fi-rr-pen-field"></i>
                      <span class="menu-label">Compose</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/email/read-email') }}">
            ...
            <div class="tab-pane fade" id="pagesTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/pricing') }}">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/blog') }}">
                      <i class="fi fi-rr-blog-text"></i>
                      <span class="menu-label">Blog Grid</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/blog-list') }}">
                      <i class="fi fi-rr-blog-text"></i>
                      <span class="menu-label">Blog List</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/blog-details') }}">
                      <i class="fi fi-rr-blog-text"></i>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/error-404') }}">
                      <i class="fi fi-rs-404"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/error-404-cover') }}">
                      <i class="fi fi-rs-404"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/error-404-full') }}">
                      <i class="fi fi-rs-404"></i>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/under-construction') }}">
                      <i class="fi fi-rr-under-construction"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/under-construction-cover') }}">
                      <i class="fi fi-rr-under-construction"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/pages/under-construction-full') }}">
                      <i class="fi fi-rr-under-construction"></i>
                      <span class="menu-label">Full</span>
                    </a>
                  </li>
            ...
            <div class="tab-pane fade" id="authenticationTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/login-basic') }}">
                      <i class="fi fi-rr-unlock"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/login-cover') }}">
                      <i class="fi fi-rr-unlock"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/register-basic') }}">
                      <i class="fi fi-rr-enter"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/register-cover') }}">
                      <i class="fi fi-rr-enter"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/register-frame') }}">
                      <i class="fi fi-rr-enter"></i>
                      <span class="menu-label">Frame</span>
                    </a>
                  </li>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/forgot-password-basic') }}">
                      <i class="fi fi-rs-otp"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/forgot-password-cover') }}">
                      <i class="fi fi-rs-otp"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/forgot-password-frame') }}">
                      <i class="fi fi-rs-otp"></i>
                      <span class="menu-label">Frame</span>
                    </a>
                  </li>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/new-password-basic') }}">
                      <i class="fi fi-rr-password-alt"></i>
                      <span class="menu-label">Basic</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/new-password-cover') }}">
                      <i class="fi fi-rr-password-alt"></i>
                      <span class="menu-label">Cover</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/authentication/new-password-frame') }}">
                      <i class="fi fi-rr-password-alt"></i>
                      <span class="menu-label">Frame</span>
                    </a>
                  </li>
            ...
            <div class="tab-pane fade" id="componentsTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/accordion') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Accordion</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/alerts') }}">
                      <i class="fi fi-rs-bell"></i>
                      <span class="menu-label">Alerts</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/badge') }}">
                      <i class="fi fi-rr-tags"></i>
                      <span class="menu-label">Badge</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/breadcrumb') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Breadcrumb</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/buttons') }}">
                      <i class="fi fi-rr-toggle-on"></i>
                      <span class="menu-label">Buttons</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/typography') }}">
                      <i class="fi fi-rr-text"></i>
                      <span class="menu-label">Typography</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/button-group') }}">
                      <i class="fi fi-rr-toggle-on"></i>
                      <span class="menu-label">Button Group</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/card') }}">
                      <i class="fi fi-rr-credit-card"></i>
                      <span class="menu-label">Card</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/collapse') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Collapse</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/carousel') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Carousel</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/dropdowns') }}">
                      <i class="fi fi-rs-settings-sliders"></i>
                      <span class="menu-label">Dropdowns</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/modal') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Modal</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/navbar') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Navbar</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/list-group') }}">
                      <i class="fi fi-rr-list"></i>
                      <span class="menu-label">List Group</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/tabs') }}">
                      <i class="fi fi-rr-tab-folder"></i>
                      <span class="menu-label">Tabs</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/offcanvas') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Offcanvas</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/pagination') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Pagination</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/popovers') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Popovers</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/progress') }}">
                      <i class="fi fi-sr-bars-progress"></i>
                      <span class="menu-label">Progress</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/scrollspy') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Scrollspy</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/spinners') }}">
                      <i class="fi fi-br-loading"></i>
                      <span class="menu-label">Spinners</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/toasts') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
                      <span class="menu-label">Toasts</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/components/tooltips') }}">
                      <i class="fi fi-rr-flux-capacitor"></i>
            ...
            <div class="tab-pane fade" id="extendedTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/extended-ui/avatar') }}">
                      <i class="fi fi-rr-circle-user"></i>
                      <span class="menu-label">Avatar</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/extended-ui/card-action') }}">
                      <i class="fi fi-rr-credit-card"></i>
                      <span class="menu-label">Card action</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/extended-ui/drag-and-drop') }}">
                      <i class="fi fi-rr-arrows"></i>
                      <span class="menu-label">Drag & drop</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/extended-ui/simplebar') }}">
                      <i class="fi fi-rr-star"></i>
                      <span class="menu-label">Simplebar</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/extended-ui/swiper') }}">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/icons/flaticon') }}">
                      <i class="fi fi-rr-star"></i>
                      <span class="menu-label">Flaticon</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/icons/lucide') }}">
                      <i class="fi fi-rr-star"></i>
                      <span class="menu-label">Lucide</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/icons/fontawesome') }}">
                      <i class="fi fi-rr-star"></i>
            ...
            <div class="tab-pane fade" id="formElementsTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/form-elements') }}">
                      <i class="fi fi-rr-form"></i>
                      <span class="menu-label">Form Elements</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/form-floating') }}">
                      <i class="fi fi-rr-form"></i>
                      <span class="menu-label">Form Floating</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/form-input-group') }}">
                      <i class="fi fi-rr-form"></i>
                      <span class="menu-label">Form Input Group</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/form-layout') }}">
                      <i class="fi fi-rr-form"></i>
                      <span class="menu-label">Form Layout</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/form-validation') }}">
                      <i class="fi fi-rr-form"></i>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/flatpickr') }}">
                      <i class="fi fi-rr-calendar-lines"></i>
                      <span class="menu-label">Flatpickr</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/forms/tagify') }}">
                      <i class="fi fi-rr-tags"></i>
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/table/tables-basic') }}">
                      <i class="fi fi-rr-table-list"></i>
                      <span class="menu-label">Table</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/table/tables-datatable') }}">
            ...
            <div class="tab-pane fade" id="chartsTab" role="tabpanel" tabindex="0">
              <nav class="app-navbar" data-simplebar>
                <ul class="side-menubar">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/chart/apexchart') }}">
                      <i class="fi fi-br-chart-histogram"></i>
                      <span class="menu-label">Apex Chart</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/chart/chartjs') }}">
                  ...
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/maps/jsvectormap') }}">
                      <i class="fi fi-rr-marker"></i>
                      <span class="menu-label">JS Vector Map</span>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="{{ url('/nexlink/maps/leaflet') }}">
            ...
            <div class="row">
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog1.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">CRM Analytics Made Simple: Visualize Growth with Real-Time Dashboards</a>
                        </h5>
                        ...
                        <a href="{{ url('/nexlink/pages/blog-details') }}" class="btn btn-sm btn-outline-primary stretched-link">Read More</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog2.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">Automate Your Workflow: Boost Sales Efficiency with Smart CRM Tools</a>
                        </h5>
                        <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                          <li class="d-flex gap-1 align-items-center">
                            <i class="icon-calendar text-primary"></i>
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog3.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">Customer Insights: How Data Shapes Stronger Relationships</a>
                        </h5>
                        <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                          <li class="d-flex gap-1 align-items-center">
                            <i class="icon-calendar text-primary"></i>
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog4.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">The Power of AI in CRM: Smarter Data, Faster Results</a>
                        </h5>
                        <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                          <li class="d-flex gap-1 align-items-center">
                            <i class="icon-calendar text-primary"></i>
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog5.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">Integrating CRM with Marketing: The Ultimate Growth Strategy</a>
                        </h5>
                        <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                          <li class="d-flex gap-1 align-items-center">
                            <i class="icon-calendar text-primary"></i>
              ...
              <div class="col-12 m-b30">
                <div class="card card-body">
                  <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                      <img src="{{ asset('nexlink/assets/images/blog/blog6.webp') }}" class="img-fluid rounded" alt="...">
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                      <div class="card-body px-0 px-md-4">
                        <h5>
                          <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">Data Security in CRM: Protecting Your Business and Customers</a>
                        </h5>
                        <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                          <li class="d-flex gap-1 align-items-center">
                            <i class="icon-calendar text-primary"></i>
                  ...
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item px-0">
                        <div class="d-flex gap-3 align-items-center">
                          <div class="avatar avatar-xl">
                            <img src="{{ asset('nexlink/assets/images/blog/recent/blog1.webp') }}" alt="">
                          </div>
                          <div class="flex-fill">
                            <h6 class="mb-1">
                              <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">
                      ...
                      <li class="list-group-item px-0">
                        <div class="d-flex gap-3 align-items-center">
                          <div class="avatar avatar-xl">
                            <img src="{{ asset('nexlink/assets/images/blog/recent/blog2.webp') }}" alt="">
                          </div>
                          <div class="flex-fill">
                            <h6 class="mb-1">
                              <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">
                      ...
                      <li class="list-group-item px-0">
                        <div class="d-flex gap-3 align-items-center">
                          <div class="avatar avatar-xl">
                            <img src="{{ asset('nexlink/assets/images/blog/recent/blog3.webp') }}" alt="">
                          </div>
                          <div class="flex-fill">
                            <h6 class="mb-1">
                              <a href="{{ url('/nexlink/pages/blog-details') }}" class="text-dark">
                    ...
                    <div class="row g-1">
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic1.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic2.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic3.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic4.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic5.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                      <div class="col-4">
                        <a href="javascript:void(0);">
                          <img src="{{ asset('nexlink/assets/images/gallery/pic6.jpg') }}" class="img-fluid rounded-2" alt="">
                        </a>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row g-2">
          ...
          <div class="col-lg-6 col-md-5">
            <ul class="d-flex list-inline mb-0 gap-3 flex-wrap justify-content-center justify-content-md-end">
              <li>
                <a class="text-body" href="{{ url('/nexlink') }}">Home</a>
              </li>
              <li>
  ...
  <script src="{{ asset('nexlink/assets/libs/global/global.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/libs/flatpickr/flatpickr.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/appSettings.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/main.js') }}"></script>
