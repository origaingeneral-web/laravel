...
<!-- Mirrored from nexlink.layoutdrop.com/demo/pages/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
...
<body>
    ...
    <main class="app-wrapper d-flex align-items-center justify-content-center">
      ...
      <div class="container">
        <div class="error-wrapper text-center">
          ...
          <a href="{{ url('/nexlink') }}" class="btn btn-primary waves-effect waves-light">
  ...
  <script src="{{ asset('nexlink/assets/libs/lottiefiles/lottie.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/lottie.js') }}"></script>
