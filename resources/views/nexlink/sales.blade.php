...
<!-- Mirrored from nexlink.layoutdrop.com/demo/sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:44 GMT -->
<head>
  ...
  <meta name="twitter:card" content="summary">js
  ...
  <link rel="stylesheet" href="{{ asset('nexlink/assets/libs/datatables/datatables.min.css') }}">
...
<body>
                ...
                <div class="row g-1">
                    ...
                    <div class="p-3 border rounded">
                      <div class="d-flex align-items-center mb-1">
                        <div class="avatar rounded-circle avatar-xxs me-2">
                          <img src="{{ asset('nexlink/assets/images/country/uk.html') }}" alt="">
                        </div>
                  ...
                  <div class="col-xxl-12 col-lg-6 col-md-12 col-sm-6">
                    <div class="p-3 border rounded">
                      <div class="d-flex align-items-center mb-1">
                        <div class="avatar rounded-circle avatar-xxs me-2">
                          <img src="{{ asset('nexlink/assets/images/country/china.html') }}" alt="">
                        </div>
                  ...
                  <div class="col-xxl-12 col-lg-6 col-md-12 col-sm-6">
                    <div class="p-3 border rounded">
                      <div class="d-flex align-items-center mb-1">
                        <div class="avatar rounded-circle avatar-xxs me-2">
                          <img src="{{ asset('nexlink/assets/images/country/germany.html') }}" alt="">
                        </div>
                  ...
                  <div class="col-xxl-12 col-lg-6 col-md-12 col-sm-6">
                    <div class="p-3 border rounded">
                      <div class="d-flex align-items-center mb-1">
                        <div class="avatar rounded-circle avatar-xxs me-2">
                          <img src="{{ asset('nexlink/assets/images/country/japan.html') }}" alt="">
                        </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar4.html') }}" alt="">
                          </div>
                          Noah Davis
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar6.html') }}" alt="">
                          </div>
                          Ethan Miller
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar7.html') }}" alt="">
                          </div>
                          Ava Taylor
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar8.html') }}" alt="">
                          </div>
                          Mason Brown
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar9.html') }}" alt="">
                          </div>
                          Isabella Martinez
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/avatar/avatar10.html') }}" alt="">
                          </div>
                          James Anderson
                        </div>
                      </td>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/1.html') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/2.html') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/3.html') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/4.html') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/5.html') }}" alt="">
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="{{ asset('nexlink/assets/images/product/6.html') }}" alt="">
                          </div>
  ...
  <script src="{{ asset('nexlink/assets/libs/datatables/datatables.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/libs/apexcharts/apexcharts.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/plugins/datatable.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/dashboard/sales.js') }}"></script>
...
<!-- Mirrored from nexlink.layoutdrop.com/demo/sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:48 GMT -->
</html>