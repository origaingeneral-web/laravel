...
<!-- Mirrored from nexlink.layoutdrop.com/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:09 GMT -->
<head>
...
<body>
        ...
        <div class="row">
          ...
          <div class="col-xxl-3 col-lg-6">
            <div class="row">
              ...
              <div class="col-12">
                <div class="card overflow-hidden bg-primary border-0 ovarlay-primary-gradient" style="background-image: url({{ asset('nexlink/assets/images/wind.html') }}); background-position: center; background-size: cover;">
              ...
              <div class="card-body gradient-layer" style="height: 325px;" data-simplebar>
                <div class="p-3 bg-light bg-opacity-50 mb-2 rounded">
                  ...
                  <div class="text-1xs d-flex gap-1 align-items-center">
                    <img src="{{ asset('nexlink/assets/images/icons/google-meet.html') }}" alt="">
  ...
  <script src="{{ asset('nexlink/assets/libs/sortable/Sortable.min.js') }}"></script>
  <script src="{{ asset('nexlink/assets/libs/chartjs/chart.js') }}"></script>
  ...
  <script src="{{ asset('nexlink/assets/js/dashboard/dashboard.js') }}"></script>
  <script src="{{ asset('nexlink/assets/js/plugins/todolist.js') }}"></script>
...
<!-- Mirrored from nexlink.layoutdrop.com/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:36 GMT -->
</html>