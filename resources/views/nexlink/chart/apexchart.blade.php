...
<!-- Mirrored from nexlink.layoutdrop.com/demo/chart/apexchart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:44 GMT -->
<head>
...
<body>
  ...
  <script src="{{ asset('nexlink/assets/js/chart/apexchart.js') }}"></script>
