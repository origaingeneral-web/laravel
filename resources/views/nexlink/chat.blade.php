...
<!-- Mirrored from nexlink.layoutdrop.com/demo/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:42 GMT -->
<head>
                ...
                <div class="chat-nav" id="myTab" role="tablist" data-simplebar>
                  <a href="javascript:void(0);" class="chat-nav-item">
                    <div class="avatar rounded-circle avatar-status-success">
                      <img src="{{ asset('nexlink/assets/images/avatar/vector/avatar1.html') }}" alt="">
                    </div>
                  ...
                  <a href="javascript:void(0);" class="chat-nav-item active">
                    <div class="avatar rounded-circle avatar-status-success">
                      <img src="{{ asset('nexlink/assets/images/avatar/vector/avatar2.html') }}" alt="">
                    </div>
                    <div class="chat-avatar-info">
                      <div class="clearfix">
                  ...
                  <a href="javascript:void(0);" class="chat-nav-item">
                    <div class="avatar rounded-circle avatar-status-danger">
                      <img src="{{ asset('nexlink/assets/images/avatar/vector/avatar3.html') }}" alt="">
                    </div>
                    <div class="chat-avatar-info">
                      <div class="clearfix">
                  ...
                  <a href="javascript:void(0);" class="chat-nav-item">
                    <div class="avatar rounded-circle avatar-status-danger">
                      <img src="{{ asset('nexlink/assets/images/avatar/vector/avatar4.html') }}" alt="">
                    </div>
                    <div class="chat-avatar-info">
                      <div class="clearfix">
                  ...
                  <a href="javascript:void(0);" class="chat-nav-item">
                    <div class="avatar rounded-circle">
                      <img src="{{ asset('nexlink/assets/images/avatar/vector/avatar5.html') }}" alt="">
                    </div>
                    <div class="chat-avatar-info">
                      <div class="clearfix">
...
<!-- Mirrored from nexlink.layoutdrop.com/demo/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:43 GMT -->
</html>