...
<!-- Mirrored from nexlink.layoutdrop.com/demo/finance.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:48 GMT -->
<head>
...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xxl-3 col-xl-4">
            <div class="card overflow-hidden bg-primary ovarlay-primary-gradient border-0" style="background-image: url({{ asset('nexlink/assets/images/wind.html') }}); background-position: center; background-size: cover;">
  ...
  <script src="{{ asset('nexlink/assets/js/dashboard/finance.js') }}"></script>
