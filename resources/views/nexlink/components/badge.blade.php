...
<!-- Mirrored from nexlink.layoutdrop.com/demo/components/badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:50 GMT -->
<head>
              ...
              <div class="card-body">
                <div class="d-flex flex-wrap gap-2">
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-primary bg-primary-subtle border border-primary-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar1.webp') }}" alt="">Primary
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-secondary bg-secondary-subtle border border-secondary-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar2.webp') }}" alt="">Secondary
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-success bg-success-subtle border border-success-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar3.webp') }}" alt="">Success
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-danger bg-danger-subtle border border-danger-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar4.webp') }}" alt="">Danger
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-warning bg-warning-subtle border border-warning-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar5.webp') }}" alt="">Warning
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-info bg-info-subtle border border-info-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar1.webp') }}" alt="">Info
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-dark bg-light-subtle border border-dark-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar2.webp') }}" alt="">Light
                  </span>
                  <span class="badge d-inline-flex align-items-center ps-0 pe-2 text-dark bg-dark-subtle border border-dark-subtle rounded-pill">
                    <img class="rounded-circle me-1" width="24" height="24" src="{{ asset('nexlink/assets/images/avatar/avatar3.webp') }}" alt=""> Dark
                  </span>
                </div>
              </div>
            </div>
...
<!-- Mirrored from nexlink.layoutdrop.com/demo/components/badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2026 06:45:51 GMT -->
</html>